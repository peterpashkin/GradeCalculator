...
<body>
  ...
  <p class="Bemerkung">
    Man Beachte, die kleinen Checkboxen sollen für die Halbjahre ausgewählt werden, die nicht eingebracht werden! Zudem dürfen maximal 8 Halbjahre abgewählt werden
  </p>
  <?php
...
<div class="input">
     ...
     <input type="number" name="arr2[]" value="<?php echo $grades[0][0]; ?>" class="inpud <?php if($alleeinbring[0][0]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
     <div class="check"><input type="checkbox" name="einbring[]" value=1  <?php  echo $alleeinbring[0][0];?>></div>
     <input type="number" name="arr2[]" value="<?php echo $grades[0][1]; ?>" class="inpud <?php if($alleeinbring[0][1]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
     <div class="check"><input type="checkbox" name="einbring[]" value=2  <?php  echo $alleeinbring[0][1];?>></div>
     <input type="number" name="arr2[]" value="<?php echo $grades[0][2]; ?>" class="inpud <?php if($alleeinbring[0][2]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
     <div class="check"><input type="checkbox" name="einbring[]" value=3  <?php  echo $alleeinbring[0][2];?>></div>
     <input type="number" name="arr2[]" value="<?php echo $grades[0][3]; ?>" class="inpud <?php if($alleeinbring[0][3]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
...
<div class="input">
     ...
     <input type="number" name="arr2[]" value="<?php echo $grades[1][0]; ?>" class="inpud <?php if($alleeinbring[1][0]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
     <div class="check"><input type="checkbox" name="einbring[]" value=11 <?php  echo $alleeinbring[1][0];?>></div>
     <input type="number" name="arr2[]" value="<?php echo $grades[1][1]; ?>" class="inpud <?php if($alleeinbring[1][1]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
     <div class="check"><input type="checkbox" name="einbring[]" value=12 <?php  echo $alleeinbring[1][1];?>></div>
     <input type="number" name="arr2[]" value="<?php echo $grades[1][2]; ?>" class="inpud <?php if($alleeinbring[1][2]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
     <div class="check"><input type="checkbox" name="einbring[]" value=13 <?php  echo $alleeinbring[1][2];?>></div>
     <input type="number" name="arr2[]" value="<?php echo $grades[1][3]; ?>" class="inpud <?php if($alleeinbring[1][3]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
...
<div class="input">
     ...
     <input type="number" name="arr2[]" value="<?php echo $grades[2][0]; ?>" class="inpud <?php if($alleeinbring[2][0]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
     <div class="check"><input type="checkbox" name="einbring[]" value=21 <?php  echo $alleeinbring[2][0];?>></div>
     <input type="number" name="arr2[]" value="<?php echo $grades[2][1]; ?>" class="inpud <?php if($alleeinbring[2][1]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
     <div class="check"><input type="checkbox" name="einbring[]" value=22 <?php  echo $alleeinbring[2][1];?>></div>
     <input type="number" name="arr2[]" value="<?php echo $grades[2][2]; ?>" class="inpud <?php if($alleeinbring[2][2]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
     <div class="check"><input type="checkbox" name="einbring[]" value=23 <?php  echo $alleeinbring[2][2];?>></div>
     <input type="number" name="arr2[]" value="<?php echo $grades[2][3]; ?>" class="inpud <?php if($alleeinbring[2][3]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
...
<div class="input">
     ...
     <input type="number" name="arr2[]" value="<?php echo $grades[3][0]; ?>" class="inpud <?php if($alleeinbring[3][0]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
     <div class="check"><input type="checkbox" name="einbring[]" value=31 <?php  echo $alleeinbring[3][0];?>></div>
     <input type="number" name="arr2[]" value="<?php echo $grades[3][1]; ?>" class="inpud <?php if($alleeinbring[3][1]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
     <div class="check"><input type="checkbox" name="einbring[]" value=32 <?php  echo $alleeinbring[3][1];?>></div>
     <input type="number" name="arr2[]" value="<?php echo $grades[3][2]; ?>" class="inpud <?php if($alleeinbring[3][2]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
     <div class="check"><input type="checkbox" name="einbring[]" value=33 <?php  echo $alleeinbring[3][2];?>></div>
     <input type="number" name="arr2[]" value="<?php echo $grades[3][3]; ?>" class="inpud <?php if($alleeinbring[3][3]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
...
<div class="input">
     ...
     <input type="number" name="arr2[]" value="<?php echo $grades[4][0]; ?>" class="inpud <?php if($alleeinbring[4][0]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
     <div class="check"><input type="checkbox" name="einbring[]" value=41 <?php  echo $alleeinbring[4][0];?>></div>
     <input type="number" name="arr2[]" value="<?php echo $grades[4][1]; ?>" class="inpud <?php if($alleeinbring[4][1]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
     <div class="check"><input type="checkbox" name="einbring[]" value=42 <?php  echo $alleeinbring[4][1];?>></div>
     <input type="number" name="arr2[]" value="<?php echo $grades[4][2]; ?>" class="inpud <?php if($alleeinbring[4][2]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
     <div class="check"><input type="checkbox" name="einbring[]" value=43 <?php  echo $alleeinbring[4][2];?>></div>
     <input type="number" name="arr2[]" value="<?php echo $grades[4][3]; ?>" class="inpud <?php if($alleeinbring[4][3]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
...
<div class="input">
     ...
     <input type="number" name="arr2[]" value="<?php echo $grades[5][0]; ?>" class="inpud <?php if($alleeinbring[5][0]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
     <div class="check"><input type="checkbox" name="einbring[]" value=51 <?php  echo $alleeinbring[5][0];?>></div>
     <input type="number" name="arr2[]" value="<?php echo $grades[5][1]; ?>" class="inpud <?php if($alleeinbring[5][1]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
     <div class="check"><input type="checkbox" name="einbring[]" value=52 <?php  echo $alleeinbring[5][1];?>></div>
     <input type="number" name="arr2[]" value="<?php echo $grades[5][2]; ?>" class="inpud <?php if($alleeinbring[5][2]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
     <div class="check"><input type="checkbox" name="einbring[]" value=53 <?php  echo $alleeinbring[5][2];?>></div>
     <input type="number" name="arr2[]" value="<?php echo $grades[5][3]; ?>" class="inpud <?php if($alleeinbring[5][3]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
...
<div class="input">
     ...
     <input type="number" name="arr2[]" value="<?php echo $grades[6][0]; ?>" class="inpud <?php if($alleeinbring[6][0]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
     <div class="check"><input type="checkbox" name="einbring[]" value=61 <?php  echo $alleeinbring[6][0];?>></div>
     <input type="number" name="arr2[]" value="<?php echo $grades[6][1]; ?>" class="inpud <?php if($alleeinbring[6][1]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
     <div class="check"><input type="checkbox" name="einbring[]" value=62 <?php  echo $alleeinbring[6][1];?>></div>
     <input type="number" name="arr2[]" value="<?php echo $grades[6][2]; ?>" class="inpud <?php if($alleeinbring[6][2]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
     <div class="check"><input type="checkbox" name="einbring[]" value=63 <?php  echo $alleeinbring[6][2];?>></div>
     <input type="number" name="arr2[]" value="<?php echo $grades[6][3]; ?>" class="inpud <?php if($alleeinbring[6][3]=='checked'){echo 'ausgewaehlt';}?>" min=0 max=15>
